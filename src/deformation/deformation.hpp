...
struct scene_environment_with_shader_deformation : cgp::scene_environment_basic
{
	...
	void update(cgp::mesh& lac, cgp::mesh_drawable& lac_visual, perlin_noise_parameters & parameters, float t); // function to be called in the scene display - update the time t and the light position
};
